...
const Portfolio = () => {
    // State for the Loading/Blur effect
    ...
    // AUTOMATIC BLUR REMOVAL EFFECT
    useEffect(() => {
        // Reduced to 800ms for faster loading
    ...
    // Prevent scrolling while blurred
    useEffect(() => {
        if (isLoading) {
    ...
    return (
        <>
            {/* ------------------------------------------
              ...
              ------------------------------------------
            */}
            <div className={`min-h-screen bg-white dark:bg-black text-gray-900 dark:text-gray-100 font-sans transition-all duration-700 ease-out ${
                isLoading 
                ? 'blur-xl grayscale scale-105 pointer-events-none h-screen overflow-hidden' 
                            ...
                            {filteredProjects.map((project, idx) => (
                                ...
                                >
                                    <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
                                        ...
                                        {/* FIXED BUTTON LAYOUT FOR MOBILE AND DESKTOP */}
                                        <div className="flex flex-row md:flex-col gap-3 mt-4 md:mt-0 w-full md:w-auto">
                                            <a
                                                href={project.github}
                                                className="flex-1 md:flex-none px-4 py-2 border border-gray-300 dark:border-gray-700 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-900 transition-colors flex items-center justify-center gap-2"
                                            >
                                                <Github size={16} />
                                                Code
                                            </a>
                                            <a
                                                href={project.live}
                                                className="flex-1 md:flex-none px-4 py-2 bg-black dark:bg-white text-white dark:text-black rounded-lg hover:opacity-90 transition-opacity flex items-center justify-center gap-2"
                                            >
